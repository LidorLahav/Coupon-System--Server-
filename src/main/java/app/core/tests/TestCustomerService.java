...
public class TestCustomerService {
    ...
    /**
     * Testing methods of CustomerService: getCoupons(), purchaseCoupon(coupon),
     * getCustomerCoupons(), getCustomerCoupons(category),
     * getCustomerCoupons(maxPrice), getCouponByTitle(title),
     * getCouponsByCategory(category), getCustomerDetails()
     * 
    ...
    public void start(CustomerService customerService) {
        ...
        if (couponsByCategory.size() == 0) {
            System.out.println(
                    "	there are no coupons with category: " + Category.Vacation.toString() + ", in the system");
        }
