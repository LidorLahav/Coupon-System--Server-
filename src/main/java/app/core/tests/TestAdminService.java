...
public class TestAdminService {
    ...
    /**
     * Adds companies and customers to database, testing the methods
     * addCompany(company) and addCustomer(customer) of AdminService
     * 
     * @param adminService
     */
        ...
        for (int i = 0; i < 5; i++) {
            try {
                adminService.addCustomer(
                        createCustomer("customer" + i + "@gmail.com", "firstName" + i, "lastName" + i, "pass" + i));
            } catch (CouponSystemException e) {
                System.out.println(e.getMessage());
            }
        }
    ...
    /**
     * Testing methods of AdminService: getAllCompanies(), getAllCustomers(),
     * deleteCompany(companyId), deleteCustomer(customerId),
     * getOneCompany(companyId), getOneCustomer(customerId), updateCompany(company),
     * updateCustomer(customer), getCompanyCoupons(companyId),
