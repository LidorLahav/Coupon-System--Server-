...
public class TestCompanyService {
    ...
    /**
     * Adds company coupons to database, using company1 testing the method
     * addCoupon(coupon) of CompanyService
     * 
     * @param companyService
     */
    public void initializeCoupons1(CompanyService companyService) {
        try {
            Coupon coupon1 = createCoupon(Category.Electricity, "coupon1", "electronics", LocalDate.parse("2022-02-03"),
                    LocalDate.parse("2024-02-03"), 30, 70.3, "image1");
            companyService.addCoupon(coupon1);
            Coupon coupon2 = createCoupon(Category.Food, "coupon2", "foodies", LocalDate.parse("2022-04-05"),
                    LocalDate.parse("2024-04-05"), 35, 77.3, "image2");
            companyService.addCoupon(coupon2);
            Coupon coupon3 = createCoupon(Category.Restaurant, "coupon3", "kepasa", LocalDate.parse("2021-01-27"),
                    LocalDate.parse("2021-02-10"), 40, 37, "image3");
            companyService.addCoupon(coupon3);
            Coupon coupon4 = createCoupon(Category.Vacation, "coupon4", "hotels", LocalDate.parse("2021-01-27"),
                    LocalDate.parse("2021-06-09"), 5, 230, "image4");
    ...
    /**
     * Adds company coupons to database, using company2 testing the method
     * addCoupon(coupon) of CompanyService
     * 
     * @param companyService
     */
    public void initializeCoupons2(CompanyService companyService) {
        try {
            Coupon coupon1 = createCoupon(Category.Attractions, "coupon5", "escape room", LocalDate.parse("2021-05-03"),
                    LocalDate.parse("2023-02-04"), 10, 50.3, "image5");
            companyService.addCoupon(coupon1);
            Coupon coupon2 = createCoupon(Category.Attractions, "coupon6", "cinema", LocalDate.parse("2021-02-05"),
                    LocalDate.parse("2021-11-15"), 123, 13.3, "image6");
            companyService.addCoupon(coupon2);
            Coupon coupon3 = createCoupon(Category.Furniture, "coupon7", "chair", LocalDate.parse("2021-02-27"),
                    LocalDate.parse("2021-07-12"), 2, 37, "image7");
            companyService.addCoupon(coupon3);
            Coupon coupon4 = createCoupon(Category.Vacation, "coupon8", "tzimer", LocalDate.parse("2021-01-27"),
                    LocalDate.parse("2021-08-23"), 1, 230, "image8");
            companyService.addCoupon(coupon4);
            System.out.println("addCoupon succeeded");
        } catch (CouponSystemException e) {
            System.out.println(e.getMessage());
    ...
    /**
     * Testing methods of CompanyService: getCompanyCoupons(), updateCoupon(coupon),
     * deleteCoupon(couponID), getCompanyCoupons(category),
     * getCompanyCoupons(maxPrice), getCompanyDetails()
     * 
     * @param companyService
     */
    ...
    private Coupon createCoupon(Category category, String title, String description, LocalDate startDate,
